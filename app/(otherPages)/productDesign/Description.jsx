import PinkDownloadIcon from "../../icons/PinkDownloadIcon";
  ...
  return (
    <section className="px-[4.25rem] max-md:px-[2.25rem] max-sm:px-0 max-sm:pl-[1.88rem]">
      <div className="flex flex-row justify-between items-center bg-[#FFFFF] pt-[5.81rem] pr-[1.87rem] max-md:pr-[1rem]">
        ...
        <div className=" flex flex-row justify-between items-center gap-[0.62rem] border border-solid border-[#DA004C] py-[0.625rem] px-[1.25rem] rounded-[0.625rem] max-lg:py-[.5rem] max-lg:px-[1rem] max-md:px-[.7rem] max-sm:border-none ">
          {/* underline underline-offset-4 */}
          <PinkDownloadIcon />
          <button
            href="/"
            className="text-[#DA004C] text-[1.1rem] font-semibold leading-normal max-md:text-[1rem] max-sm:underline max-sm:underline-offset-4"
          >
            Download Scheme
          </button>
        </div>
      ...
      <div className="flex flex-row mt-[2.96rem] gap-[2.81rem] max-sm:flex-col">
        <button className=" py-[0.62rem] px-[1.25rem] bg-[#DA004C] text-[#FFFFFF] w-[12.875rem] rounded-[0.625rem] text-[1.25rem] font-semibold leading-normal max-sm:w-[13.875rem]">
          Register
        </button>
        <button className=" bg-[#FFFFFF]  py-[0.62rem] px-[1.25rem] w-[16.3125rem] text-[#DA004C] rounded-[0.3125rem] border border-solid border-[#DA004C] text-[1.25rem] font-semibold leading-normal max-sm:w-[13.875rem] max-sm:text-[1.125rem]">
          Speak to our admin
        </button>
      </div>
    </section>
